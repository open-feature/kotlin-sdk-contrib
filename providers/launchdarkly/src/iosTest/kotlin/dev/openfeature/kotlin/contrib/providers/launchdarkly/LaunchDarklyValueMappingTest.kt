...
/**
 * Verifies [Value] <-> LaunchDarkly iOS (SwiftPM) [LDValue] mapping via round-trip.
 */
...
class LaunchDarklyValueMappingTest {
    ...
    /**
     * LD may store whole-number doubles as JSON integers, so [toValue] can yield [Value.Integer].
     */
